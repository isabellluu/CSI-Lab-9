...
int main() 
{
   ...
   /* II. Call new functions ********FUNCTIONS**********                                                                                                                                                  
    ...
    //e. Repeat steps a-d four more times and save to ints i1, i2, i3 ect.
    i2 = division2(i1, num1);
    
    i3 = division3(i2, num2);
    
    i4 = division4(i3, num3);
    
    i5 = division5(i4, num4);
    
    
    //III. Display Data
    //a. Use printf to display the ints i1-i5 with spaces in between each integer
    printf("Your number is: %i %i %i %i %i\n", i1, i2, i3, i4, i5);
...
/*************************************** Function division ******************************************/
int division4 (int ii4, int num4)
{   
    /*b. Use integer divison to divide a by b and save to int divided
     c. Call function mod
     d. Use module to save the remainder of the answer
...
/*************************************** Function division ******************************************/
int division5 (int ii5, int num5)
{   
    /*b. Use integer divison to divide a by b and save to int divided
     c. Call function mod
     d. Use module to save the remainder of the answer
